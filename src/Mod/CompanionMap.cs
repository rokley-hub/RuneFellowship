...
namespace Rune.Mod
{
    public partial class Plugin
    {
        ...
        private Sprite defaultCompanionMapIcon;
        private void SetCompanionMapIcon(Minimap.PinData pin, bool direwolf) {
            if(!defaultCompanionMapIcon) defaultCompanionMapIcon=pin.m_icon;
            pin.m_icon=direwolf ? Rune.Direwolf.DirewolfSkin.LoadMountIcon() : defaultCompanionMapIcon;
            pin.m_doubleSize=direwolf;
            if(pin.m_iconElement) pin.m_iconElement.sprite=pin.m_icon;
        }
        ...
        private void LateUpdate()
        {
            ...
            foreach (var c in visible) {
                ...
                SetCompanionMapIcon(pin,c.Appearance=="direwolf");
            }
        }
        private void UpdateDistantPins(Companion[] visible) {
            ...
            if(Player.m_localPlayer && Solo && ZDOMan.instance != null) {
                ...
                foreach(string appearance in new[]{"skeleton","draugr","elite","dwarf","wolf","direwolf"}) {
                ...
                foreach(var zdo in zdos) {
                    ...
                    SetCompanionMapIcon(pin,zdo.GetPrefab()==PrefabFor("direwolf").GetStableHashCode());
                }
            }
