...
public sealed partial class RuneWindow
{
    ...
    private void ShowCommands()
    {
        ...
        var examples = new (string Group, string Command, string Detail)[] { ("Adventure", "summon", "Bring the selected companion into this world."), ("Adventure", "follow me", "Cancel the current job and follow you, keeping cargo."), ("Adventure", "stay here", "Hold position and stop the current job."), ("Adventure", "return", "Deliver cargo and borrowed equipment."), ("Gathering", "gather twenty wood", "Harvest nearby trees and collect the drops."), ("Gathering", "collect ten stone", "Collect loose stone or mine with a pickaxe."), ("Equipment", "pick up the stone axe and use it", "Pick up one axe, equip it and keep it when returning cargo."), ("Gathering", "pick up all items", "Keep collecting nearby loose items."), ("Gathering", "exclude resin", "Skip an item during automatic pickup."), ("Base", "set base here", "Remember a work area with your own chests."), ("Base", "sort storage", "Organize items across accessible chests."), ("Base", "cook food", "Tend supported cooking stations."), ("Base", "manage base", "Cook and sort during a bounded shift."), ("Building", "planbuild camp shelter on me", "Use the exact saved PlanBuild design name at your position."), ("Building", "planbuild camp shelter on yourself", "Use that design at the selected companion position."), ("Building", "build this blueprint", "Gather materials and complete your unfinished PlanBuild pieces within 25 metres."), ("Building", "build a workbench", "Gather wood and place a bench near where you give the order; needs a hammer."), ("Building", "clear crafting", "Stop construction; leave unfinished plans and deposited materials."), ("Crafting", "gather materials for a karve", "Collect known recipe ingredients nearby."), ("Crafting", "make a bronze axe", "Gather missing materials, craft and keep the result. Equip useful gear."), ("Crafting", "clear crafting", "Clear this companion's crafting checklist and stop related work. Keep collected items."), ("Boats", "build a karve", "Build at a valid shoreline and workbench."), ("Information", "status", "Report task, health, and cargo.") };
